   ...
   session_start(); 
        ...
        if (mysqli_connect_errno())
            ...
            $level = $_SESSION['level'];
               ...
               $sql1 = "SELECT * FROM nguoiungho WHERE tenTaiKhoan = '$user'";
           
           
            $result1 = mysqli_query($db,$sql1);
            $row1 = mysqli_fetch_array($result1);
            $idnguoi =  $row1['idNguoiUngHo'];
   ...
   <body >
      ...
      <div class="main" style="background: rgb(219, 245, 245);padding-top:100px;">
         <div class="container" style="background: rgb(219, 245, 245);">
            ...
            <div class="row py-5" style="margin:0px -100px ;">
               <div class="col-lg-10 mx-auto"  >
                  <div class="card rounded shadow border-0"  >
                     <div class="card-body p-5 bg-white rounded" >
                        <h3 style="text-align: center;">Lịch sử ủng hộ</h3>
                           ...
                           <table id="example" style="width:100%" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                 <?php 
                                   ...
                                   and dangkyungho.idNguoiUngHo = '$idnguoi' ";
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $row['tenDotCuuTro'] ?></td>
                                    ...
                                    <td><a href="chitietlichsu.php?id=<?php echo $row['idDangKyUngHo'] ?>"> Xem chi tiêt</a> </td>                                     
                                 </tr>
                                 <?php
                                    }
                                    }
