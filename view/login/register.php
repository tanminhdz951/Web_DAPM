...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="f../../fonts/material-icon/css/material-design-iconic-font.min.css">
...
<body>
    ...
    <div class="main" style="padding: 20px 0;" >
        ...
        <!-- Sign up form -->
        <section class="signup" style="margin-bottom: 20px;">
            <div class="container">
                    ...
                    <div class="signup-form">
                        ...
                        <?php include('errors.php'); ?>
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" id="full_name" required="_required" placeholder="Full Name"/>
                            </div>
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            ...
                            <div class="form-group">
                                <label for="phone"><i class="zmdi zmdi-phone"></i></label>
                                <input type="text" name="address" id="address"required="_required" placeholder="Your Address"/>
                            </div>
